...
*/
		...
		{	
			...
			//	add_management_page( 'Registration logs', 'Registration logs', 'edit_users', 'Registration Logs', array(&$ttc_registration_plugin, 'ttc_add_user_registration_menu'));
			//}
		...
		function ttc_add_user_registration_menu()
		{
			...
			if (!current_user_can('manage_options'))  {
				...
				print "<table border=\"1\"><th>This is your email banished list:  <br>Add or remove emails as you wish<br>One per line </th><tr><td>.info<br>@googlemail.com<br>muraskiken@gmail.com</td></tr>";
				...
				print "<form method=\"post\">";
				print "<table border=\"1\"><th>This is your ip banished list:  <br>Add or remove ips as you wish <br> One per line</th><tr><td>77.10.106.4<br>78.129.208.100<br>10.10.255.255</td></tr>";
