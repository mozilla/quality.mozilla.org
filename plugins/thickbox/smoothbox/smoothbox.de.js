...
function TB_show(caption, url, rel){
    ...
    if (baseURL.match(imageURL)) {
        ...
        imgPreloader.onload = function(){
            ...
            $("TB_window").innerHTML += "<a href='' id='TB_ImageOff' title='Schlie&szlig;en'><img id='TB_Image' src='" + url + "' width='" + imageWidth + "' height='" + imageHeight + "' alt='" + caption + "'/></a>" + "<div id='TB_caption'>" + caption + "<div id='TB_secondLine'>" + imageCount + prev.html + next.html + "</div></div><div id='TB_closeWindow'><a href='#' id='TB_closeWindowButton' title='Schlie&szlig;en'>Schlie&szlig;en</a></div>";
