...
<?php if ( dpa_change_picture_has_pictures() && current_user_can( 'upload_files' ) ) : ?>
	...
	<div class="list-head no-ajax pagination">
		<p id="pag-count-head" class="pag-count"><?php dpa_change_picture_pagination_count() ?></p>
  <?php if ( dpa_change_picture_pagination() ) : ?>
		<p id="pages-head" class="pages"><?php dpa_change_picture_pagination(); ?></p>
	<?php endif; ?>
	</div>
