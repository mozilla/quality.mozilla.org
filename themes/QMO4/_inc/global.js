...
/***
 * NOTE: This version of Easing conflicts with current versions of jQuery. 
 * Commenting out until that conflict is resolved in some future release.
 * Scripts that reference Easing should degrade gracefully. 
 */
...
jq(document).ready( function() {
	...
	if ( jq.query.get('r') && jq('textarea#whats-new').length ) {
		...
		jq.scrollTo( jq('textarea#whats-new'), 500, { offset:-125 } );
