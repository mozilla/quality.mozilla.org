...
<div id="member-head" class="hcard">
  <div class="member-info">
    <h1 class="fn"><a class="url" href="<?php bp_user_link(); ?>"><?php bp_member_name(); ?> <?php bp_displayed_user_avatar( 'type=full&width=100&height=100' ); ?></a></h1>
		...
		<ul class="admin-links">
		  <li><?php echo $user_email; ?></li>
			...
			<?php if ( !bp_core_is_user_spammer( $bp->displayed_user->id ) ) : ?>
				<li><a href="<?php echo $bp->displayed_user->domain . $bp->settings->slug ?>/capabilities/"><?php _e( "Mark as Spammer", 'qmo' ) ?></a></li>
			<?php else : ?>
				<li><a href="<?php echo $bp->displayed_user->domain . $bp->settings->slug ?>/capabilities/"><?php _e( "Not a Spammer", 'qmo' ) ?></a></li>
			<?php endif; ?>
			<li><a href="<?php echo $bp->displayed_user->domain . $bp->settings->slug ?>/delete-account/"><?php printf( __( "Delete %s", 'qmo' ), esc_attr( $bp->displayed_user->fullname ) ) ?></a></li>
		</ul>
  <?php endif; ?>
