...
<?php do_action( 'bp_before_footer' ); ?>
  ...
  <?php if (get_page_by_path('about')) : ?>
   If you would like to help with coding of QA  please see the following a href="https://github.com/mozilla/quality.mozilla.org" rel="Conttribute to the code">Contribute to the code</a></p>
  <?php if (get_page_by_path('about')) : ?>
