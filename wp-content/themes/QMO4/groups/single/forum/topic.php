      ...
      <?php while ( bp_forum_topic_posts() ) : bp_the_forum_topic_post(); ?>
        ...
        <li id="post-<?php bp_the_topic_post_id() ?>" class="hentry">
          <div class="poster-meta">
            ...
            <span class="entry-title"><?php echo sprintf( __( '%s said %s ago:', 'qmo' ), bp_get_the_topic_post_poster_name(), bp_get_the_topic_post_time_since() ); ?></span>
      ...
      <?php if ( bp_get_the_topic_is_last_page() ) : ?>
        ...
        <?php else : ?>
          ...
          <div id="message" class="info">
            <p><?php _e( 'This topic is closed. Replies are no longer accepted.', 'qmo' ) ?></p>
          </div>
