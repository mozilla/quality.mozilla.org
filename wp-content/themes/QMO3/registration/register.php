...
<section id="content-main" class="hfeed" role="main">
		  ...
		  <?php do_action( 'bp_before_register_page' ) ?>
			<form action="" name="signup_form" id="signup_form" class="standard-form full" method="post" enctype="multipart/form-data">

			<?php if ( 'request-details' == bp_get_current_signup_step() ) : ?>
				<h1 class="page-title"><?php _e( 'Create an Account', 'buddypress' ) ?></h1>

				<?php do_action( 'template_notices' ); ?>
				<p><?php _e( 'Registering for this site is easy, just fill in the fields below and we\'ll have your new account set up in no time.', 'buddypress' ) ?></p>
					 ...
					 <li>
					   ...
					   <?php endif; ?>
							...
							<?php if ( 'radio' == bp_get_the_profile_field_type() ) : ?>
								<div class="check">
									<em class="label"><?php bp_the_profile_field_name() ?> <?php if ( bp_get_the_profile_field_is_required() ) : ?><?php _e( '(required)', 'buddypress' ) ?><?php endif; ?></em>
									<?php do_action( 'bp_' . bp_get_the_profile_field_input_name() . '_errors' ) ?>
									<?php bp_the_profile_field_options(); ?>
								</div>
							<?php endif; ?>
		  ...
		  <?php endif; /* end profile details */ ?>
				<?php do_action( 'bp_after_signup_profile_fields' ); ?>

				<?php /***** Blog Creation Details ******/ ?>
				<?php if ( bp_get_blog_signup_allowed() ) : ?>
					<?php do_action( 'bp_before_blog_details_fields' ) ?>
					<fieldset class="register-section" id="blog-details-section">
				...
				<p class="submit">
					<button type="submit"name="signup_submit" id="signup_submit"><?php _e( 'Complete Sign Up', 'buddypress' ); ?></button>
				</p>
			...
			<?php if ( 'completed-confirmation' == bp_get_current_signup_step() ) : ?>
				...
				<h1 class="page-title"><?php _e( 'Sign Up Complete!', 'buddypress' ) ?></h1>
